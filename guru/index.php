...
$sql = mysqli_query($koneksi,"SELECT * FROM tbl_guru
 WHERE id = '$_SESSION[guru]'") or die(mysqli_error($koneksi));
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(isset($_GET['p'])){if($_GET['p'] == 'absensi'){echo "active";}}?>"
                            aria-current="page" href="../guru/index.php?p=absensi">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Absensi Siswa</span>
                        </a>
                    </li>
