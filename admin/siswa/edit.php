<?php 
	$edit = mysqli_query($koneksi,"SELECT * FROM tbl_siswa WHERE id='$_GET[id]' ");
	foreach ($edit as $d)?>
                        ...
                        <form action="" method="post" id="formsiswa">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="nis" name="nis" onkeypress="return checkNumber(event)" required readonly value="<?=$d['nis']?>">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="radio" id="jkl" name="jk" class="form-check-input" value="L" <?=$d['jenis_kelamin']=='L'?'checked':''?>>
                                    <label class="form-check-label" for="jkl" value="P">Laki-laki</label>&nbsp;&nbsp;&nbsp;
                                    <input type="radio" id="jkp" name="jk" class="form-check-input" value="P" <?=$d['jenis_kelamin']=='P'?'checked':''?>>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="telp" name="telp" onkeypress="return checkNumber(event)" required value="<?=$d['no_telp']?>">
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control" id="alamat" name="alamat" required rows="3"><?=$d['alamat']?></textarea>
                                </div>
                            </div>
                            <button name="saveSiswa" type="button" class="btn btn-primary" onclick="savedata()">Ubah Data</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    function savedata(){
        Swal.fire({
            title: 'Apakah Anda Ingin Mengubah <br>Data Siswa Ini ?',
            showDenyButton: true,
...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $save= mysqli_query($koneksi,"UPDATE tbl_siswa SET nama='$_POST[nama]', kelas='$_POST[kelas]', jenis_kelamin='$_POST[jk]', no_telp='$_POST[telp]', alamat='$_POST[alamat]' ,email='$_POST[email]' WHERE id='$_GET[id]'");
    if ($save) {
        echo "
