            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Daftar Riwayat Data Siswa</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatable" class="table table-bordered" data-toggle="data-table">
                            ...
                            <tbody>
                                <?php
                                $no=1;
                                $datamst = mysqli_query($koneksi,"SELECT * FROM tbl_siswa WHERE deleted=1 ORDER BY nama ASC");
