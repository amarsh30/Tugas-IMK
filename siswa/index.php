...
$sql = mysqli_query($koneksi,"SELECT * FROM tbl_siswa
 WHERE id = '$_SESSION[siswa]'") or die(mysqli_error($koneksi));
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(isset($_GET['p'])){if($_GET['p'] == 'spp'){echo "active";}}?>"
                            aria-current="page" href="../siswa/index.php?p=spp">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="item-name">Pembayaran SPP</span>
                        </a>
                    </li>
